...
class DaoEstoqueMovimentacao:
    @classmethod
    def criar_movimentacao_estoque(cls, session, tipo_movimentacao: str, id_historico_estoque: int, estoque_antes_empresa: int, quantidade: int, estoque_antes_cliente: int = None):
